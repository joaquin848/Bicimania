/* VARIABLES */
let menuItems,
    rowMountain = document.querySelector("#row-mountain"),
    rowCarreras = document.querySelector("#row-carreras"),
    rowPaseo = document.querySelector("#row-paseo"),
    rowElectricas = document.querySelector("#row-eléctricas"),
    ...
    validUser = {user: "maci", pass: "maci848"},
...
function createMenuCard(type, description, price, available, source) {
    ...
    switch (type) {
        case "Mountain":
            rowMountain.appendChild(divCol);
            break;
        case "Carreras":
            rowCarreras.appendChild(divCol);
            break;
        case "Paseo":
            rowPaseo.appendChild(divCol);
            break;
        case "Eléctricas":
            rowElectricas.appendChild(divCol);
            break;
    }
...
function createSettingsRow(type, description, price, available, source) {
    ...
    option1.value = "Mountain";
    option1.textContent = "Mountain";
    inputType.appendChild(option1);
    let option2 = document.createElement("option");
    option2.value = "Carreras";
    option2.textContent = "Carreras";
    inputType.appendChild(option2);
    let option3 = document.createElement("option");
    option3.value = "Paseo";
    option3.textContent = "Paseo";
    inputType.appendChild(option3);
    let option4 = document.createElement("option");
    option4.value = "Eléctricas";
    option4.textContent = "Eléctricas";
...
function createMenuAndSettings(products) {
    ...
    rowMountain.innerHTML = "";
    rowCarreras.innerHTML = "";
    rowPaseo.innerHTML = "";
    rowElectricas.innerHTML = "";
